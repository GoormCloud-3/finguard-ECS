...
import inspect
from models.schema import TransactionItem
...
async def get_account(account_id: str):
    ...
    try:
        ...
        logging.info(
            "📅TransactionItem.date type: %r",
            TransactionItem.model_fields["date"].annotation,
        )
        logging.info("TransactionItem src: %s", inspect.getsourcefile(TransactionItem))
        logging.info(
            "TransactionItem.date annotation: %r",
            TransactionItem.model_fields["date"].annotation,
        )
        ...
        transactions = [
            {
                ...
                "date": _to_date_str(
                    row.get("date")
                ),  # 항상 'YYYY-MM-DD' 문자열 또는 None
                "time": _to_time_str(
                    row.get("time")
                ),  # 항상 'HH:MM:SS' 문자열 또는 None
